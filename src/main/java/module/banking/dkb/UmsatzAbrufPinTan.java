...
public class UmsatzAbrufPinTan
{
   ...
   */
  private final static String USER = "1036988358_p";
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    // In der AuthPassport-Datei speichert HBCI4Java die Daten des Bankzugangs (Bankparameterdaten, Benutzer-Parameter, etc.).
    ...
    // Erzeugen des AuthPassport-Objektes.
    HBCIPassport passport = AbstractHBCIPassport.getInstance();
    
    // Konfigurieren des AuthPassport-Objektes.
    ...
    {
      // Sicherstellen, dass sowohl AuthPassport als auch Handle nach Beendigung geschlossen werden.
      if (handle !=null)
        handle.close();
  ...
  private static class MyHBCICallback extends AbstractHBCICallback
  {
    ...
    public void callback(HBCIPassport passport, int reason, String msg, int datatype, StringBuffer retData)
    {
      ...
      switch (reason)
      {
        // Mit dem Passwort verschluesselt HBCI4Java die AuthPassport-Datei.
